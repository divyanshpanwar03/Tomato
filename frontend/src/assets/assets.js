...
export const assets ={
    basket_icon,logo,header_img,search_icon,remove_icon_red,app_store,play_store,linkedin_icon,facebook_icon,twitter_icon,cross_icon,selector_icon,profile_icon,bag_icon,rating_starts,logout_icon,
    add_icon,
    ...
    order_icon,logoo,
    profile_image,
    upload_area,add_icon_green, add_icon_white,
    parcel_icon
}
